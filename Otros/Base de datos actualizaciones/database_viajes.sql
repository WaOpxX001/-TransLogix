...
-- Tabla para seguimiento de ubicaciones en tiempo real (opcional)
...
('VJ-002', 'Nuevo León', 'Monterrey', 'Puerto Industrial', 'Jalisco', 'Guadalajara', 'Almacén Norte', 2, 2, 'TechCorp México', 'Electrónicos', 800.00, '2025-01-12', '10:30:00', 'pendiente', 'Carga frágil - manejar con cuidado'),
